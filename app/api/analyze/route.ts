      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-10">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
            Copiază textul sau încarcă documentul. AI-ul îți explică ce spune, ce trebuie să faci, până când — în română curată.
          </p>
        </div>
      </section>
          ...
          {activeTab === "analyze" && (
            <div className="p-10">
              {!response ? (
                <>
                  {/* Upload zone */}
                  <div className="relative border-2 border-dashed border-gray-300 rounded-2xl p-10 text-center hover:border-[#1B4D3E] hover:bg-[#F5F1E8]/30 transition-all mb-6 group cursor-pointer">
                    <input
                      type="file"
                      accept=".txt"
                    ...
                    />
                    <div className="w-14 h-14 mx-auto bg-[#F5F1E8] group-hover:bg-[#1B4D3E] rounded-full flex items-center justify-center mb-4 transition-colors">
                      <svg className="w-7 h-7 text-[#1B4D3E] group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                      </svg>
                    </div>
                    <p className="font-playfair text-lg font-semibold text-[#0A0A0A] mb-1">
                      Încarcă fișier
                    </p>
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-xs font-medium text-gray-500 uppercase tracking-widest">sau lipește text</span>
                    <div className="flex-1 h-px bg-gray-200"></div>
                  </div>
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">
                          {confidence >= 85
                            ...
                            : confidence >= 70
                              ...
                              : confidence >= 50
                                ? "Document parțial neclar. Recomandăm expert."
                                : "Consultă un expert pentru verificare."}
                        </p>
                      </div>
                    </div>
                  </div>
